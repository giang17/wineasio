/*
 * Minimal WineASIO test DLL - STEP 1B
 * Based on working minimal, HeapAlloc code commented out
 */
...
{
    OutputDebugStringA("[MinimalASIO-Step1b] ");
